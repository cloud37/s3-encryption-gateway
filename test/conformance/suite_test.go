	...
	for _, p := range providers {
		...
		t.Run(p.Name(), func(t *testing.T) {
			...
			cases := []struct {
				...
				{"ListObjectsV1_SizeAccuracy_MultiPage", provider.CapSizeTranslation, testListObjectsV1_SizeAccuracy_MultiPage},
				{"ListObjectsV2_SizeAccuracy_MultiPage", provider.CapSizeTranslation, testListObjectsV2_SizeAccuracy_MultiPage},
				{"ListObjects_SizeAccuracy_FallbackHead", provider.CapSizeTranslation, testListObjects_SizeAccuracy_FallbackHead},
				...
				{"OpenBao_TokenRevocation", provider.CapOpenBaoKMS, testOpenBaoKMSTokenRevocation},
				...
				{"SEC44_Auth_SigV2HeaderSubresourceAccepted", provider.CapObjectACL, testSEC44_Auth_SigV2HeaderSubresourceAccepted},
				{"SEC44_Auth_SigV2HeaderSubresourceSubstitutionRejected", provider.CapObjectACL, testSEC44_Auth_SigV2HeaderSubresourceSubstitutionRejected},
