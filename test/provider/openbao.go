...
const openBaoImage = "quay.io/openbao/openbao:2.7.0"
...
// using the dev-server root token. The endpoint stays open, so the only way back
// for a client is a fresh login.
